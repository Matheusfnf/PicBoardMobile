import { SafeAreaView, StyleSheet, Text, TouchableOpacity, View, Modal, Image, StatusBar } from 'react-native';
      ...
      return (
        ...
        />
          ...
          <TouchableOpacity 
                ...
                >          
                  <MaterialIcons name="flip-camera-android" size={50} color="#ffffff" />
          </TouchableOpacity>
          ...
          <Camera style={styles.camera} type={type} flashMode={flash} ref={camRef}></Camera>
